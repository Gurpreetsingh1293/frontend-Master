export function JourneyRabbit({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 72" className={className} role="img" aria-label="Your place on the learning path">
      ...
      <path d="M18 18c-1-12 6-18 10-8 1 3 1 10 0 14" fill="#f7f4ee" stroke="#1a1630" strokeWidth="1.4" />
      <path d="M46 18c1-12-6-18-10-8-1 3-1 10 0 14" fill="#f7f4ee" stroke="#1a1630" strokeWidth="1.4" />
